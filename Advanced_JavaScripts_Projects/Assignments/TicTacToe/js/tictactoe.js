    ...
    function computersTurn() {
        ...
        while (!success) {
            ...
            if (placeXOrO(pickASquare)) {
                ...
                // This changes our boolean nd ends the loop.
                success = true;
            };
        }
    }
...
function drawWinLine(coordX1, coordY1, coordX2, coordY2) {
    ...
    // This line gives us access to methods and properties to use on canveas.
    ...
    function animateLineDrawing() {
        ...
        // This condition is similar to the one above but slightly different.
        // This is necessary for the 6, 4, 2 win conditions.
        if (x1 <= x2 && y1 >= y2){
            // This condition adds 10 to the previous end x endpoint.
            if (x < x2) { x += 10; }
            // This condition subtracts 10 from the previous end y endpoint.
            if (y > y2) { y -= 10; }
            // This condition is similar to the one above.
            // This is necessary for the 6, 4, 2 win conditions.
            if (x >= x2 && y <= y2) { cancelAnimationFrame(animationLoop); }
