...
// This validates the form, and returns a message if the user leaves a field empty
function validatePizzaForm() {
    let firstName = document.forms["pizzaForm"]["firstName"].value;
    let lasttName = document.forms["pizzaForm"]["lastName"].value;
    let email = document.forms["pizzaForm"]["email"].value;
    let phoneNumber = document.forms["pizzaForm"]["phoneNumber"].value;
    let message = document.forms["pizzaForm"]["message"].value;

    if (firstName == "" || lasttName == "" || email == "" || phoneNumber == "" || message == "") {
        alert("Fill out all fields, or no free pizza!");
        return false;
    }
    // If they fill out all of the fields, this will allow form submission
    return true; 
